...
#         plt.legend(loc='upper left')
# displayRetireWRates(800,[0.3,0.5,0.7],40*12)
...
def displayRetireWMonthsAndRates1(monthlies,rates,terms):
    plt.figure('retireBoth')
    plt.clf()
    plt.xlim(30*12,40*12)
    monthLabels=['r','b','g','k']
    ...
    for i in range(len(monthlies)):
        ...
        for j in range(len(rates)):
            ...
            plt.legend(loc='upper left')
displayRetireWMonthsAndRates1([500,700,900,1100],[.03,.05,.07],40*12)
